...
(function () {
    ...
    s.e = function (a, c) {
        ...
        c.innerHTML || (this.v = t.e("div", {className: "vjs-control-content"}), this.xb = t.e("span", {
    ...
    s.e = function () {
        ...
        if (!c || this.movingMediaElementInDOM === l)c ? (d = c.cloneNode(l), t.h.Bb(c), c = d, a.I = k) : (c = t.e("video"), t.Kc(c, t.g.z(a.ie || {}, {
            id: a.id() + "_html5_api",
            "class": "vjs-tech"
    ...
    t.f = t.q.extend({
        i: function (a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.b = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", j = a.m, j = t.g.z({
                ...
                loop: j.loop,
                muted: j.muted
            }, c.flashVars), n = t.g.z({wmode: "opaque", bgcolor: "#000000"}, c.params), h = t.g.z({
                id: h,
                name: h,
                "class": "vjs-tech"
            }, c.attributes);
