...
public class ActorScanner {
    ...
    static void ScheduleActors() {
        ...
        for(final Class<?> schedule : schedules) {
            final ActorRef actor = Akka.system().actorOf(GuiceExtension.GuiceProvider.get(Akka.system()).props((Class<? extends Actor>) schedule));
    ...
    static void ScheduleOnceActors() {
        ...
        for(final Class<?> scheduleOnce : schedules) {
            final ActorRef actor = Akka.system().actorOf(GuiceExtension.GuiceProvider.get(Akka.system()).props((Class<? extends Actor>) scheduleOnce));
